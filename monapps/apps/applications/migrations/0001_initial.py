    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('df_schema', models.JSONField(blank=True, default=dict)),
                ('settings_jsonschema', models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_status_eval', models.BigIntegerField(default=60000)),
                ('time_curr_state_eval', models.BigIntegerField(default=60000)),
